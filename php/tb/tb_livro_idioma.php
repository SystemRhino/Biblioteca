...
$(document).ready(function(){
  $("#salvar").click(function(){
    var v1 = $("#id_livro").val();
    var v2 = $("#id_idioma").val();
    $.ajax({
    url: "./script/script_livro_idioma.php",
    type: "POST",
    data: "id_livro="+v1+"&id_idioma="+v2,
    dataType: "html"
...
try {
include("conecta.php");
$listagem = $conn->prepare("SELECT * FROM tb_livro_idioma");
$listagem->execute();
...
?>
  <tr>
    ...
    <td><?php echo $lista['id_idioma'];?></td>
    <td><a id="deletar" type="button" class="btn btn-danger btn-sm" href="deletar.php?tb=tb_livro_idioma&&id=<?php echo $lista['id'];?>">Deletar</a></td>
  </tr>
<?php
  }
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Livro Idioma</h5>
...
<select id="id_idioma" class="form-select" aria-label="Default select example">
  <option>Selecione o autor</option>
<?php
include("conecta.php");
...
while ($lista = $listagem->fetch(PDO::FETCH_ASSOC)) {
?>
<option value="<?php echo $lista['id']?>"><?php echo $lista['nm_idioma']?></option>
<?php
  }
?>
</select>
