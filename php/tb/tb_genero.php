...
$(document).ready(function(){
  $("#salvar").click(function(){
    var v1 = $("#nm_genero").val();
    $.ajax({
    url: "./script/script_genero.php",
    type: "POST",
    data: "nm_genero="+v1,
    dataType: "html"
...
?>
  <tr>
    ...
    <td><?php echo $lista['nm_genero'];?></td>
    <td><a id="deletar" type="button" class="btn btn-danger btn-sm" href="deletar.php?tb=tb_genero&&id=<?php echo $lista['id'];?>">Deletar</a></td>
  </tr>
<?php
  }
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="text" class="form-control" id="nm_genero" placeholder="Nome gênero"><br>
      </div>
