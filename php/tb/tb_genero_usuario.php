...
$(document).ready(function(){
  $("#salvar").click(function(){
    ...
    $.ajax({
    url: "./script/script_genero_usuario.php",
    type: "POST",
    data: "id_usuario="+v1+"&id_genero="+v2,
    dataType: "html"
...
<h2>Gênero Usuario</h2>
<table>
    <tr>
    <th>ID Gênero Usuario</th>
    <th>ID Gênero</th>
    <th>ID Usuario</th>
  </tr>
<?php
try {
include("conecta.php");
$listagem = $conn->prepare("SELECT * FROM tb_genero_usuario");
$listagem->execute();
...
?>
  <tr>
    ...
    <td><a id="deletar" type="button" class="btn btn-danger btn-sm" href="deletar.php?tb=tb_genero_usuario&&id=<?php echo $lista['id'];?>">Deletar</a></td>
  </tr>
<?php
  }
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Gênero Usuario</h5>
